...
var task = Export.table.toDrive({
  collection: vectors,
  description:'Intertidal_Zones_std_022_3img',
...
Export.image.toDrive({
  ...
  folder: 'Intertidal_Zones', 
  fileNamePrefix:'img_ndwi_std_022',
  region:geometry, 
  scale: 10,
  maxPixels: 100e9});

...
print('NWI masked', NWI)// Visualizar NDWI histograma
...
print('intertidal_zones', intertidal_zones)
//// Exportar vetores
var task = Export.table.toDrive({
  collection: vectors,
  description:'Intertidal_Zones_linguado_MNDWI',
...
Export.image.toDrive({
  ...
  folder: 'Intertidal_Zones', 
  fileNamePrefix:'img_linguado_MNDWI',
  region:geometry, 
  scale: 10,
  maxPixels: 100e9});
